...
<div class="gp-doc-container gp-content">
    ...
    <p>Ad esempio questa pagina è caricabile dal link: <a href="<?php echo gpRouter::getInstance()->getSite();?>/ajax?module=staticcontent&view=moduli"><?php echo gpRouter::getInstance()->getSite();?>/ajax?module=staticcontent&view=moduli</a></p>
