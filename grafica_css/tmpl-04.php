  ...
  <div class="ecs-container">
    ...
    <div class="ecs-body">
      <nav id="sidebar" class="ecs-sidebar ejs-sidebar-status-mobile-hide">
        <div class="ejs-sidebar-content">
          <div class="ecs-pr1">
            ...
            require('template-part/tmpl-04-sidebar.php'); ?>
          </div>
        </div>
      ...
      <main class="ecs-content">
        <?php 
        if (is_file('template-part/tmpl-04-content-'.$active.'.php')) {
          require('template-part/tmpl-04-content-'.$active.'.php');
        } else {
          echo 'Da creare template-part/tmpl-04-content-'.$active.'.php';
        }
        ?>
      </main>
